...
<div class="page-header fade-up">
    ...
    <div>
        ...
        <p class="text-muted mb-0">
            ...
            Kelola seluruh data unit kerja.
    ...
    <a
        href="{{ route('admin.unit.kerja.create') }}"
...
<div class="content-card fade-up">
    ...
    <div class="card-header">
        ...
        <form
            action="{{ route('admin.unit.kerja.index') }}"
            method="GET"
            class="search-box">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {{ $loop->iteration + ($unitKerja->firstItem() - 1) }}
                        ...
                        <td>
                            ...
                            <div class="table-actions">
                                ...
                                <a
                                    href="{{ route('admin.unit.kerja.show',$item->id) }}"
                                ...
                                <a
                                    href="{{ route('admin.unit.kerja.edit',$item->id) }}"
                                ...
                                <form
                                    action="{{ route('admin.unit.kerja.destroy',$item->id) }}"
                                    method="POST"
